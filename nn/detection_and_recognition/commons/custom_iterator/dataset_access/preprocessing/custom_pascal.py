...
class CustomPascalGenerator(Generator):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CustomPascalGenerator, self).__init__(**kwargs)
    ...
    def __parse_annotations(self, xml_root):
        ...
        """
        annotations = {'labels': np.empty((len(xml_root.findall('object')),)), 'boxes': np.empty((len(xml_root.findall('object')), 4))}
