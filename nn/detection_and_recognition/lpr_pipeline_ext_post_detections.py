...
def main(args):
    ...
    while True:
        ...
        draw_detections(frame,
                        detections_off_device['car_boxes'], detections_off_device['car_type_scores'],
                        detections_off_device['car_type'],
                        detections_off_device['boxes'], detections_off_device['scores'],
                        detections_off_device['numbers'],
...
if __name__ == '__main__':
    ...
    parser.add_argument("--stnetru_checkpoint_path",
                        default="E:/Models/LPR/LPR_with_mtcnn/RU/stn_Iter_045300_model.ckpt",
                        help="path to weights for ru_stn")
    parser.add_argument("--stnetkz_checkpoint_path",
                        default="E:/Models/LPR/LPR_with_mtcnn/KZ/stn_Iter_063000_model.ckpt",
                        help="path to weights for ru_stn")
    parser.add_argument("--lprnetru_checkpoint_path",
                        default="E:/Models/LPR/LPR_with_mtcnn/RU/lprnet_Iter_045300_model.ckpt",
                        help="path to weights for ru_stn")
    parser.add_argument("--lprnetkz_checkpoint_path",
                        default="E:/Models/LPR/LPR_with_mtcnn/KZ/lprnet_Iter_063000_model.ckpt",
                        help="path to weights for ru_stn")
    parser.add_argument("--onet_checkpoint_path", default="E:/Models/LPR/LPR_with_mtcnn/onet_Weights",
                        help="path to weights for mtcnn_lpr")
    parser.add_argument("--pnet_checkpoint_path", default="E:/Models/LPR/LPR_with_mtcnn/pnet_Weights",
                        help="path to weights for mtcnn_lpr")
    parser.add_argument("--onet_car_checkpoint_path", default="E:/Models/LPR/car_det_mtcnn/onet_Weights",
                        help="path to weights for mtcnn_car")
    parser.add_argument("--pnet_car_checkpoint_path", default="E:/Models/LPR/car_det_mtcnn/pnet_Weights",
                        help="path to weights for mtcnn_car")
    # parser.add_argument("--file_full_name", default="D:/Share/pexels-kelly-lacy-5473765.mp4",
    #                     help="path to the video file")
    parser.add_argument("--file_full_name", default="D:/Share/Auto.mkv",
                        help="path to the video file")
