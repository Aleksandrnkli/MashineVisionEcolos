...
from mtcnn.model.MTCNN import PNet
import time
import copy
import torch.nn as nn
from settings import get_const_for_pnet_train

learning_mode = "CAR"
MP, kernel, cls_num = get_const_for_pnet_train(learning_mode)
def weights_init(m):
...
def main():
    train_path = 'E:/DataSets/LicensePlate/mtcnn/imglist_anno_12_trainval.txt'
    val_path = 'E:/DataSets/LicensePlate/mtcnn/imglist_anno_12_test.txt'
    batch_size = 64
    ...
    model = PNet(MP, kernel, cls_num, is_train=True).to(device)
